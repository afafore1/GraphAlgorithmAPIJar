...
public class Graph implements IGraph {
	 ...
	 */
    @Override
	public void AddVertex(Point location, String label, String type, int capacity)
    {
    	Vertex v = new Vertex(_graphId, location, label, type, capacity);    	
    	_vertices.put(_graphId, v);
    	_graphId++;
    }
    ...
    {
    	Vertex v = new Vertex(_graphId, label);
    	_vertices.put(_graphId, v);
    	_graphId++;
    }
